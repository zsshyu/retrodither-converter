...
**Phase 10: i18n 修复与 Bloom 效果 (v1.5.x)**
- [x] 修复 i18n 翻译缺失问题 (Bloom, Palette 等缺少 HTML ID)
- [x] 新增泛光效果 (Bloom)：可调强度、阈值、半径
- [x] 配置 vite-plugin-singlefile 单文件构建
- [x] 修复 itch.io zip 结构问题
- [x] 修复原图对比功能布局崩溃问题

**Phase 11: 算法简化与默认值调整 (v1.6.x)**
- [x] 默认像素大小改为 1px
- [x] 移除 Floyd-Steinberg、Atkinson、Jarvis 算法
- [x] 新增 None (无抖动) 选项
- [x] 更新 i18n 翻译 (中/英/法)
- [x] 删除未使用的算法文件

**Phase 12: 预设风格调整 (v1.7.0)**
- [x] 重命名 "Retro Blue (Target)" → "Retro Blue"
- [x] 删除 Macintosh 预设
- [x] 新增 Sunset 预设 (红色调)
- [x] 切换到 None 时隐藏抖动偏差和矩阵尺寸参数

**Phase 13: 自定义调色板 (v1.8.x)**
- [x] 调色板移至预设风格和像素大小之间
- [x] 新增颜色数量选择器 (2-4)
- [x] 新增颜色选择器 (color picker) 支持自定义每个颜色
- [x] 显示 HEX 值在每个颜色下方
- [x] 修改颜色后自动切换到 Custom 预设
- [x] 预设风格和像素大小标题加粗
...
### v1.4.1 (2026-02-17) ✅
- Bayer 矩阵尺寸扩展：新增 16x16 和 32x32 选项
- 使用递归算法生成更大尺寸的 Bayer 矩阵

### v1.5.0 (2026-02-17) ✅
- i18n 修复：添加缺失的 HTML ID，修复翻译崩溃
- 新增泛光效果 (Bloom)：可调强度、阈值、半径
- 配置 vite-plugin-singlefile 单文件构建
- 修复 itch.io zip 结构问题
- 修复原图对比功能布局崩溃问题

### v1.6.0 (2026-02-17) ✅
- 默认像素大小改为 1px
- 移除 Floyd-Steinberg、Atkinson、Jarvis 算法
- 新增 None (无抖动) 选项
- 更新 i18n 翻译

### v1.7.0 (2026-02-17) ✅
- 重命名 "Retro Blue (Target)" → "Retro Blue"
- 删除 Macintosh 预设，新增 Sunset 预设
- 切换到 None 时隐藏抖动偏差/矩阵尺寸参数
